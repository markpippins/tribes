...
public class UserConfigDiagnostics {
    ...
    private final PlaybackService instrumentManager;
    private final PlaybackService playerManager;
    ...
    public UserConfigDiagnostics() {
        ...
        this.instrumentManager = PlaybackService.getInstance();
        this.playerManager = PlaybackService.getInstance();
